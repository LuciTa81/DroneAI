...
UCF-QNRF 공식 Train 파티션만 사용하고 ImageNet HRNet-W48 백본으로
초기화하는 별도 학습 레인이 준비되어 있습니다. 실행·중단·재개·증빙
수집 절차와 승인 지점은
[home5090 STEERER 학습 runbook](docs/runbooks/steerer-ucf-qnrf-training-home5090.md)을
따릅니다. UCF-QNRF Test와 공식 STEERER QNRF 체크포인트는 이 레인에서
차단됩니다.
