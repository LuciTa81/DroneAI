...
- Score: **84.0/100**
- Pass threshold: **80.0**
- Generated at: `2026-07-17T18:52:08.161251+00:00`

| Result | Category | Check | Points | Blocker | Observed |
|---|---|---|---:|:---:|---|
| PASS | manifest | Candidate identity and intended commercial scope are explicit | 10.0/10.0 | Y | {'schema_version': 1, 'candidate_id': 'pet-official-ucf-qnrf-academic-research-comparison', 'intended_use': 'commercial_product_rnd'} |
...
| PASS | decision | The bundle has one safe, non-contradictory scope | 20.0/20.0 | Y | PASS_RESEARCH_ONLY: The frozen research input chain permits research, while one or more components explicitly exclude commercial use. |
| FAIL | production rights | code has verified commercial evidence | 0.0/4.0 |  | False |
