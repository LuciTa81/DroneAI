"""Capture APGCC preflight identities without executing model inference."""
...
def capture_preflight(
    *,
    ...
    upstream_dirty = _git_output(command_runner, upstream, "status", "--porcelain")
    if upstream_dirty:
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Capture APGCC preflight identities without inference."
    )
