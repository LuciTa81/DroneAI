"""Run the frozen 36-image APGCC UCF-QNRF validation benchmark."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "official APGCC ShanghaiTech-A checkpoint."
        )
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if expected_samples != 36 or len(prepared.samples) != 36:
        raise ValueError(
            "APGCC benchmark requires exactly 36 frozen validation samples; "
