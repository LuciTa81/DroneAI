"""Run the research-only official-validation STEERER UCF-QNRF smoke."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run the frozen 36-image official UCF-QNRF validation smoke with "
            "a supplied local STEERER checkpoint."
        )
    )
