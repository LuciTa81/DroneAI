...
def test_steerer_report_runner_exposes_validation_sample_only() -> None:
    result = subprocess.run(
        [sys.executable, "scripts/run_steerer_one_sample.py", "--help"],
        cwd=ROOT,
        capture_output=True,
        text=True,
        check=True,
...
def test_steerer_unknown_sample_fails_before_adapter_construction() -> None:
    runner = importlib.import_module("scripts.run_steerer_one_sample")
